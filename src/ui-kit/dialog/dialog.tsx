...
export default function Dialog({
  ...
  const contentWrapperStyles: CSSProperties = useMemo(() => {
    ...
    return {
      position: "absolute",
      top:
        customPosition.top !== undefined ? `${customPosition.top}px` : "unset",
      right:
        customPosition.right !== undefined
          ? `${customPosition.right}px`
          : "unset",
      bottom:
        customPosition.bottom !== undefined
          ? `${customPosition.bottom}px`
          : "unset",
      left:
        customPosition.left !== undefined
