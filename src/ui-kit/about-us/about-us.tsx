    ...
    <section className={styles["about-us"]}>
      ...
      <div className={styles["about-us-content"]}>
        <p className={styles["about-us-text"]}>
          ...
          холодильников любых брендов и моделей, от бытовых до промышленных. Мы
          работаем на рынке <span className={styles.bold}>более 10 лет</span> и
          ...
          <span className={styles.bold}>диагностируем быстро</span> и устраняем
          неполадки уже <span className={styles.bold}>в день обращения</span>.
          Мы используем{" "}
          <span className={styles.bold}>только оригинальные запчасти</span>,
          предоставляем гарантию на все виды работ и всегда объясняем клиенту
          суть проблемы простыми словами.
          <br />
          <br />
          <span className={styles.bold}>Наша цель</span> — не просто
