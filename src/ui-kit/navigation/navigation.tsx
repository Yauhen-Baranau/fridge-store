        ...
        items={[
          {
            ...
            subItems: [
              {
                content: (
                  <Link href={getSubcategoryHref("1")}>
                    Замена и ремонт компонентов системы охлаждения
                  </Link>
                ),
                icon: {
              ...
              {
                content: (
                  <Link href={getSubcategoryHref("2")}>
                    Ремонт и замена электрических компонентов
                  </Link>
                ),
                icon: {
                  path: "/icons/square-small.svg",
              ...
              {
                content: (
                  <Link href={getSubcategoryHref("3")}>
                    Замена элементов системы No Frost
                  </Link>
                ),
                icon: {
                  path: "/icons/square-small.svg",
              ...
              {
                content: (
                  <Link href={getSubcategoryHref("4")}>
                    Замена и ремонт механических узлов
                  </Link>
                ),
                icon: {
                  path: "/icons/square-small.svg",
              ...
              {
                content: (
                  <Link href={getSubcategoryHref("5")}>
                    Ремонт дверей и корпуса
                  </Link>
                ),
                icon: {
                  path: "/icons/square-small.svg",
              ...
              {
                content: (
                  <Link href={getSubcategoryHref("6")}>Прочие услуги</Link>
                ),
                icon: {
                  path: "/icons/square-small.svg",
                  width: 14,
          ...
          },
          {
            ...
            subItems: [
              ...
              },
              {
                content: (
                  <Link href="https://google.com">
                    Ремонт специальных холодильных установок
                  </Link>
                ),
                icon: {
                  path: "/icons/square-small.svg",
              ...
              },
              {
                content: (
                  <Link href="https://google.com">
                    Ремонт промышленных систем охлаждения
                  </Link>
                ),
                icon: {
                  path: "/icons/square-small.svg",
